package drinsta.chaitanya.applocker.view;
...
public class ShowActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blurLockView.setTitle("Smart App Locker ");
        blurLockView.setLeftButton("Forgot Password");
    ...
    public void correct(String inputPassword) {
        ...
        Intent mainActivity1 = new Intent(this, MainActivity.class);
